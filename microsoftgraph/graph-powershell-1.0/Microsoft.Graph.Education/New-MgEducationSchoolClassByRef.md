...
### Create1 (Default)
```
New-MgEducationSchoolClassByRef -EducationSchoolId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgEducationSchoolClassByRef -InputObject <IEducationIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
