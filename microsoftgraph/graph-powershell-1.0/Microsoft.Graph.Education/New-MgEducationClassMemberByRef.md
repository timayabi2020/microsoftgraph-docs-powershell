...
### Create (Default)
```
New-MgEducationClassMemberByRef -EducationClassId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgEducationClassMemberByRef -InputObject <IEducationIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
