...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/remove-mgsecuritycaseediscoverycasereviewsetfile
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgSecurityCaseEdiscoveryCaseReviewSetFile -EdiscoveryCaseId <String> -EdiscoveryFileId <String>
 -EdiscoveryReviewSetId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgSecurityCaseEdiscoveryCaseReviewSetFile -InputObject <ISecurityIdentity> [-IfMatch <String>]
