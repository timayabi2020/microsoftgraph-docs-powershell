...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/remove-mgsecuritylabelretentionlabeldispositionreviewstage
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgSecurityLabelRetentionLabelDispositionReviewStage -DispositionReviewStageId <String>
