...
### List (Default)
```
Get-MgPolicyServicePrincipalCreationPolicy [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgPolicyServicePrincipalCreationPolicy -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
