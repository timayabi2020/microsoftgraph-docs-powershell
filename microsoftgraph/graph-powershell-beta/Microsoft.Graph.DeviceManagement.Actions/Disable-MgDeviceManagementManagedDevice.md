...
### Disable (Default)
```
Disable-MgDeviceManagementManagedDevice -ManagedDeviceId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-MgDeviceManagementManagedDevice -InputObject <IDeviceManagementActionsIdentity> [-PassThru] [-Confirm]
